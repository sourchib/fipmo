...
client.subscribe('Displays/espnext01ph/out', function (err) {
})
})
client.on('message', function (topic, message) {
// message is Buffer
console.log(message.toString())
connection.query('INSERT INTO ph VALUES(NULL,"'+message.toString()+'","'+ time_formatted + '")', function (error, results,fields) {
