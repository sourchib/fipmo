...
client.subscribe('Displays/espnext01ra/out', function (err) {
})
})
client.on('message', function (topic, message) {
// message is Buffer
console.log(message.toString())
connection.query('INSERT INTO cuaca VALUES(NULL,"'+message.toString()+'","'+ time_formatted + '")', function (error, results,fields) {
